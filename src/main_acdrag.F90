...
CALL LOAD(KLON, ILUNCI)
CALL LOAD(KLEV, ILUNCI)
CALL LOAD(KIDIA, ILUNCI)
CALL LOAD(KFDIA, ILUNCI)
CALL LOAD(KTDIA, ILUNCI)
CALL LOAD(ITOP, ILUNCI)
CALL LOAD(JLEV, ILUNCI)
CALL LOAD(JLON, ILUNCI)
...
CALL SAVE(ITOP, ILUNCI)
CALL SAVE(JLEV, ILUNCI)
CALL SAVE(JLON, ILUNCI)
