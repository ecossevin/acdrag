...
!        LAEROMASS2D: KEY TO READ VERTICALLY INTEGRATED AEROSOL MASS
!        LAEROMMR3D : KEY TO USE AEROSOL MASS MIXING RATIOS IN PHYSICS
...
!       LBMRED : activates the reduction of beta_m coefficient of EL0
!                mixing length formulation in the stratocumulus regime
!       NPBLH_MXL  : PBL height computation for mixing length;
!       NPBLH_DIAG : PBL height computation for diagnostics:
!                      0 - weak capping inversion method
!                      1 - TKE based method
!                      2 - upward displacement (L_up) method
...
LOGICAL :: LCHECKSURF ! activates the CHECK of Surfex variables
LOGICAL :: LGCHECKNAN ! activates the CHECK of Model NaN.
LOGICAL :: LEDR ! key to activate EDR (3D) diagnostic
LOGICAL :: LWINDFARM ! key to activate windfarm parametrisation
LOGICAL :: LBMRED
...
! Control key to call ALARO physics by the subroutine apl_alaro rather than the original subroutine aplpar.
LOGICAL :: LAPL_ALARO = .FALSE.

TYPE(TCAPE) :: YRCAPE

! For Arome Perturbation Paramater type
TYPE(TRPP) :: YRRPP
